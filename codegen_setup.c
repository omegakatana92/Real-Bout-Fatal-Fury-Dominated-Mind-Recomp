...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Fatal-Fury-Dominated-Mind-",
    .project_root_env = "FATAL_FURY_DOMINATED_MIND_RECOMP_PROJECT_ROOT",
    .build_dir_env = "FATAL_FURY_DOMINATED_MIND_RECOMP_BUILD_DIR",
    .force_setup_env = "FATAL_FURY_DOMINATED_MIND_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLPM_860.85_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Fatal_Fury_Dominated_Mind__Recompiled",
    .prepare_note =
